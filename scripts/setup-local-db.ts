...
const pool = new Pool({
    ...
    password: process.env.POSTGRES_PASSWORD || 'Given1542@@',
});

const schemaSql = `
-- 2. Aktifkan Extension UUID (Wajib untuk gen_random_uuid)
CREATE EXTENSION IF NOT EXISTS "uuid-ossp";
CREATE EXTENSION IF NOT EXISTS "pgcrypto";

-- =========================================================
-- 1. KONFIGURASI TOKO & USER (Local Config)
-- =========================================================
...
-- =========================================================
-- 2. MASTER DATA (Read Only - Hasil Sync dari TiDB Cloud)
-- =========================================================
...
CREATE TABLE IF NOT EXISTS products_local (
    ...
    category        VARCHAR(50),
    stock           INT DEFAULT 0, -- Added stock column directly to products for simplicity in this demo
    is_active       BOOLEAN DEFAULT TRUE,
    updated_at      TIMESTAMPTZ DEFAULT NOW()
);

-- =========================================================
-- 3. OPERASIONAL KASIR (SHIFT & SALES)
-- =========================================================
